...
### Fixed
- AppArmor: grant write permission on `/home/claude/` directory for chown

## [1.3.3] - 2026-02-22

### Fixed
- Handle missing SUPERVISOR_TOKEN gracefully in init script
...
### Fixed
- AppArmor: grant execute permission on `/package/**` for s6-overlay-suexec
